  ...
  return (
    <div className="bg-[#FAF7F2] min-h-screen py-8 text-[#17202A]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {/* Header */}
        <div className="bg-[#FAF7F2] text-[#17202A] rounded-md p-6 border border-[#E5DFC5] shadow-xs space-y-3">
          <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded bg-[#164A7B] text-[#17202A] text-xs font-bold border border-[#E5DFC5]">
            <ShieldCheck className="w-3.5 h-3.5" />
            <span className="text-white">Societal Innovation Platform</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold">
            Team THE OUTLIERS
          </h1>
          <p className="text-[#5B6875] text-xs sm:text-sm max-w-3xl leading-relaxed">
        ...
        <div className="bg-white rounded-md p-6 border border-[#E5DFC5] shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded bg-[#FAF7F2] border border-[#E5DFC5] space-y-2">
